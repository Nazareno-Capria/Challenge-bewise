namespace alphabetSoupTest
{
    public class WordSearcherTest
    {
        ...
        public void Setup()
        {
            wordSearcher = new WordSearcher(soup);
        }

        [Test]
        public void testEstaOTW()
        {

                Assert.That(wordSearcher.IsPresent("OTW"), Is.True);
        }

        [Test]
        public void testEstaZapatilla()
        {
                Assert.That(wordSearcher.IsPresent("ZAPATILLA"), Is.True);
        }

        [Test]
        public void testNoEstaZapatillas()
        {
                Assert.That(wordSearcher.IsPresent("ZAPATILLAS"), Is.False);
        }

        [Test]
        public void testEstaCazador()
        {
                Assert.That(wordSearcher.IsPresent("CAZADOR"), Is.True);
        }

        [Test]
        public void testEstaReloj()
        {
                Assert.That(wordSearcher.IsPresent("RELOJ"), Is.True);
        }

        [Test]
        public void testEstaOruga()
        {
                Assert.That(wordSearcher.IsPresent("ORUGA"), Is.True);
        }

        [Test]
        public void testEstaHormonas()
        {
                Assert.That(wordSearcher.IsPresent("HORMONAS"), Is.True);
        }

        [Test]
        public void testEstaCuchilla()
        {
                Assert.That(wordSearcher.IsPresent("CUCHILLA"), Is.True);
        }

        [Test]
        public void testNoEstaCuchillas()
        {
                Assert.That(wordSearcher.IsPresent("CUCHILLAS"), Is.False);
        }
    }
}